 ...
 */
cMessageGetIdToDataGlove::cMessageGetIdToDataGlove(
		const cMessageGetIdToDataGlove & inMessageDataGlove ) :
 ...
 */
cMessageGetIdToDataGlove * cMessageGetIdToDataGlove::clone() const {
	
	return new cMessageGetIdToDataGlove( *this );
}
