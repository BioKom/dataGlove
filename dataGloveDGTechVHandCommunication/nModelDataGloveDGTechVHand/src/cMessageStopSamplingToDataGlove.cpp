 ...
 */
cMessageStopSamplingToDataGlove::cMessageStopSamplingToDataGlove(
		const cMessageStopSamplingToDataGlove & inMessageDataGlove ) :
 ...
 */
cMessageStopSamplingToDataGlove * cMessageStopSamplingToDataGlove::clone() const {
	
	return new cMessageStopSamplingToDataGlove( *this );
}
